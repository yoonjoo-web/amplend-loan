...
const statusOptions = ['pending', 'approved', 'active', 'paid_off', 'defaulted', 'rejected'];
const loanTypeOptions = ['personal', 'auto', 'mortgage', 'business', 'student'];
        ...
        <div className="p-6">
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-900">Filter Loans</h3>
                <p className="text-sm text-slate-500">Filter the list by status and type</p>
              </div>
            </div>
