...
export default function LoanOfficerQueueTab() {
    ...
    <div className="space-y-6">
      ...
      <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
        <CardHeader className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            <CardTitle>Loan Officer Queue</CardTitle>
          ...
          {permissions.canManageLoanOfficerQueue && (
            <div className="flex gap-3 flex-wrap">
              ...
              {availableOfficers.length > 0 && (
                <Select onValueChange={(officerId) => handleAddOfficer(officerId)} value="">
                              ...
                              <TableCell {...provided.dragHandleProps}>
                                <div className="flex items-center gap-2" data-tour="drag-handle">
                                  ...
                                  <Badge className={officer.is_manual_position ? "bg-amber-600 text-white" : "bg-slate-900 text-white"}>
                                    ...
                                    {officer.is_manual_position && " LOCKED"}
                                  </Badge>
                                </div>
                              </TableCell>
