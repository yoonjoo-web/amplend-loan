...
import { ArrowLeft, ArrowRight, Check, Save, Loader2, CheckCircle2 } from "lucide-react";
    ...
    try {
      ...
      try {
        ...
        try {
          ...
          if (!permissions.canManageApplications && !permissions.canManageOwnApplications && !isPrimaryBorrower && !isCoBorrower) {
            accessDenied = true;
